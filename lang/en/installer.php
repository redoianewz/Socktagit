...
return [
    ...
    'installed'   => [
        'success_log_message' => 'Shopperzz installer successfully INSTALLED on ',
        'update_log_message'  => 'Shopperzz Installer successfully UPDATED on ',
    ],
];
